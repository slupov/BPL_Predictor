...
from .season_tables_extraction import get_team_season_data
...
def extract_motivation(home_team, away_team, date_played):
    ...
    home_team_season_data = get_team_season_data(season, date_played, home_team)
    away_team_season_data = get_team_season_data(season, date_played, away_team)

    table_pos1 = 0 if home_team_season_data is None else home_team_season_data.position
    table_pos2 = 0 if away_team_season_data is None else away_team_season_data.position

    dist1 = get_dist(table_pos1)
    dist2 = get_dist(table_pos2)
